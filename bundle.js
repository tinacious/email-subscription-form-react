...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _componentsSubscribeSubscribeJsx = __webpack_require__(157);
	
	var _componentsSubscribeSubscribeJsx2 = _interopRequireDefault(_componentsSubscribeSubscribeJsx);
	
	var mountNode = document.getElementById('subscription-form');
	
	_react2['default'].render(_react2['default'].createElement(_componentsSubscribeSubscribeJsx2['default'], {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SubscribeFormSpinner = (function (_React$Component) {
	    _inherits(SubscribeFormSpinner, _React$Component);
	
	    function SubscribeFormSpinner() {
	        _classCallCheck(this, SubscribeFormSpinner);
	
	        _get(Object.getPrototypeOf(SubscribeFormSpinner.prototype), 'constructor', this).apply(this, arguments);
	    }
	
	    _createClass(SubscribeFormSpinner, [{
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement('img', { src: this.props.image, alt: 'Spinner' })
	            );
	        }
	    }]);
	
	    return SubscribeFormSpinner;
	})(_react2['default'].Component);
	
	var SubscribeFormResult = (function (_React$Component2) {
	    _inherits(SubscribeFormResult, _React$Component2);
	
	    function SubscribeFormResult() {
	        _classCallCheck(this, SubscribeFormResult);
	
	        _get(Object.getPrototypeOf(SubscribeFormResult.prototype), 'constructor', this).apply(this, arguments);
	    }
	
	    _createClass(SubscribeFormResult, [{
	        key: 'render',
	        value: function render() {
	            var resultClasses = (0, _classnames2['default'])('subscribe-form-result', {
	    ...
	    return SubscribeFormResult;
	})(_react2['default'].Component);
	
	var SubscribeForm = (function (_React$Component3) {
	    _inherits(SubscribeForm, _React$Component3);
	
	    function SubscribeForm(props) {
	        _classCallCheck(this, SubscribeForm);
	
	        _get(Object.getPrototypeOf(SubscribeForm.prototype), 'constructor', this).call(this, props);
	    ...
	    _createClass(SubscribeForm, [{
	        key: 'onEmailChanged',
	        value: function onEmailChanged(evt) {
	            this.setState({ email: evt.target.value });
	        }
	    }, {
	        key: 'onFirstNameChanged',
	        value: function onFirstNameChanged(evt) {
	            this.setState({ firstName: evt.target.value });
	        }
	    }, {
	        key: 'onLastNameChanged',
	        value: function onLastNameChanged(evt) {
	            ...
	            $.ajax({
	                ...
	                success: function success(response) {
	                    _this.setState({
	                        sending: false,
	                        submission: 'success',
	                        message: _this.props.successMessage
	                    });
	                },
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(SubscribeFormResult, {
	                    messageType: this.state.submission,
	                    message: this.state.message }),
	                _react2['default'].createElement(SubscribeFormSpinner, { visible: this.state.sending, image: this.props.spinner }),
	                _react2['default'].createElement(
	                    'form',
	                    { onSubmit: this.submitForm.bind(this), style: formStyle },
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'subscription-form-field-group' },
	                        _react2['default'].createElement(
	                            'label',
	                            { htmlFor: 'firstNameField' },
	                            'First name'
	                        ),
	                        _react2['default'].createElement('input', { type: 'text', id: 'firstNameField', onChange: this.onFirstNameChanged.bind(this), ref: 'firstNameField', value: this.state.firstName })
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'subscription-form-field-group' },
	                        ...
	                        _react2['default'].createElement('input', { type: 'text', id: 'lastNameField', onChange: this.onLastNameChanged.bind(this), ref: 'lastNameField', value: this.state.lastName })
	                    ),
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'subscription-form-field-group' },
	                    ...
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'subscription-form-field-group' },
	                        _react2['default'].createElement('input', { type: 'submit', value: this.props.buttonTitle })
	                    )
	                )
	            );
	        }
